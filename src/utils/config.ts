...
export interface Config {
  ...
  clamavInstalled?: boolean;                       // ClamAV Engine installation status
  // Threat Databases
  databasesDownloaded?: boolean;                   // Whether threat databases have been downloaded
  autoUpdateDatabases?: boolean;                   // Auto-update databases on app start
  lastDatabaseUpdate?: string;                     // ISO timestamp of last database update
  transferDownloadDir?: string;                    // Saved directory for file transfers
}
...
const DEFAULT_CONFIG: Config = {
  ...
  clamavInstalled: false, // Default not installed
  autoCleanSchedule: {
    enabled: false,
    frequency: 'daily',
    time: '09:00',
